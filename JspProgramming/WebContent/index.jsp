		...
		<head>
			...
			<style type="text/css">
				*{
				...
				nav{
					background-color:rgba(160,160,0,0.2);
				...
				#category a:nth-child(2n-1){
					background-color: rgba(160,160,0,0.6);
				}
				#category >a:hover{
			...
			<div id="content">
				<aside>
					<div id="category">
						...
						<a href="HelloWorldServlet1" class="font_bold font_center" target="iframe">3.0 방식으로 등록</a>
						...
						<a href="LoginServlet" class="font_bold font_center" target="iframe">요청 처리 및 응답 보내기</a>
