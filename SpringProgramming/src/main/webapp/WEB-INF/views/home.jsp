...
<html>
		...
		<style type="text/css">
			...
			* {
			...
			#content1 #frontImage {
				...
				margin-left: 10px;
				padding: 10px;
				background-image: url(resources/image/smallimg.PNG);
				background-size:100% 100%;
				background-repeat: no-repeat;
	...
	<body>
			...
			<div id="content2">
				<div id="menu">
					...
					<ul>
						...
						<li><a href="phote/list" target="iframe">자료 게시판</a></li>
						<li><a href="file/list" target="iframe">주문 게시판</a></li>
					</ul>
				</div>
			<div id="content">
		...
		<div id="footer" style="color: #900090;">
			<h5>자몽이네</h5>
		</div>
	</div>
	</body>
